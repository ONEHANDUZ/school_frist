...
<html lang="en">
  <head>
    ...
    <title>ttile</title>
    <link rel="stylesheet" href="{{ asset('design/fontawesome-5.5/css/all.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('design/slick/slick.css') }}">
    <link rel="stylesheet" href="{{ asset('design/slick/slick-theme.css') }}">
    <link rel="stylesheet" href="{{ asset('design/magnific-popup/magnific-popup.css') }}">
    <link rel="stylesheet" href="{{ asset('design/css/bootstrap.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('design/css/tooplate-infinite-loop.css') }}" />
  ...
  <body>    
    ...
    <section id="infinite" class="text-white tm-font-big tm-parallax">
      ...
      <nav class="navbar navbar-expand-md tm-navbar" id="tmNav">              
        <div class="container">   
          <div class="tm-next">
              <a href="{{route('home')}}" class="navbar-brand">School</a>
          </div>             
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                  <a class="nav-link tm-nav-link" href="{{route('news')}}">News</a>
              </li>
              <li class="nav-item">
                <a class="nav-link tm-nav-link" href="{{route('needed')}}">Needed</a>
              </li>                    
            </ul>
          </div>        
        </div>
            ...
            <div class="mx-auto tm-gallery-container tm-gallery-container-2">
              <div class="tm-testimonials-carousel">
                <figure class="tm-testimonial-item">
                  <img src="{{ asset('design/img/testimonial-img-01.jpg') }}" alt="Image" class="img-fluid mx-auto">
                ...
                <figure class="tm-testimonial-item">
                  <img src="{{ asset('design/img/testimonial-img-02.jpg') }}" alt="Image" class="img-fluid mx-auto">
                ...
                <figure class="tm-testimonial-item">
                  <img src="{{ asset('design/img/testimonial-img-03.jpg') }}" alt="Image" class="img-fluid mx-auto">
                ...
                <figure class="tm-testimonial-item">
                  <img src="{{ asset('design/img/testimonial-img-04.jpg') }}" alt="Image" class="img-fluid mx-auto">
            ...
            <div class="col-12">
                <div class="mx-auto tm-gallery-container">
                    <div class="grid tm-gallery">
                      <a href="{{ asset('design/img/gallery-img-01.jpg') }}">
                        <figure class="effect-honey tm-gallery-item">
                          <img src="{{ asset('design/img/gallery-tn-01.jpg') }}" alt="Image 1" class="img-fluid">
                          <figcaption>
                            <h2><i>Physical Health <span>Exercise!</span></i></h2>
                          </figcaption>
                        </figure>
                      </a>
                      <a href="{{ asset('design/img/gallery-img-02.jpg') }}">
                        <figure class="effect-honey tm-gallery-item">
                          <img src="{{ asset('design/img/gallery-tn-02.jpg') }}" alt="Image 2" class="img-fluid">
                          <figcaption>
                            <h2><i>Rain on Glass <span>Second Image</span></i></h2>
                          </figcaption>
                        </figure>
                      </a>
                      <a href="{{ asset('design/img/gallery-img-03.jpg') }}">
                        <figure class="effect-honey tm-gallery-item">
                          <img src="{{ asset('design/img/gallery-tn-03.jpg') }}" alt="Image 3" class="img-fluid">
                          <figcaption>
                            <h2><i><span>Sea View</span> Mega City</i></h2>
                          </figcaption>
                        </figure>
                      </a>
                      <a href="{{ asset('design/img/gallery-img-04.jpg') }}">
                        <figure class="effect-honey tm-gallery-item">
                          <img src="{{ asset('design/img/gallery-tn-04.jpg') }}" alt="Image 4" class="img-fluid">
                          <figcaption>
                            <h2><i>Dream Girl <span>Thoughts</span></i></h2>
                          </figcaption>
                        </figure>
                      </a>
                      <a href="{{ asset('design/img/gallery-img-05.jpg') }}">
                        <figure class="effect-honey tm-gallery-item">
                          <img src="{{ asset('design/img/gallery-tn-05.jpg') }}" alt="Image 5" class="img-fluid">
                          <figcaption>
                            <h2><i><span>Workstation</span> Offices</i></h2>
                          </figcaption>
                        </figure>
                      </a>
                      <a href="{{ asset('design/img/gallery-img-06.jpg') }}">
                        <figure class="effect-honey tm-gallery-item">
                          <img src="{{ asset('design/img/gallery-tn-06.jpg') }}" alt="Image 6" class="img-fluid">
                          <figcaption>
                      ...
                      <a href="{{ asset('design/img/gallery-img-01.jpg') }}">
                        <figure class="effect-honey tm-gallery-item">
                          <img src="{{ asset('design/img/gallery-tn-01.jpg') }}" alt="Image 7" class="img-fluid">
                          <figcaption>
                      ...
                      <a href="{{ asset('design/img/gallery-img-02.jpg') }}">
                        <figure class="effect-honey tm-gallery-item">
                          <img src="{{ asset('design/img/gallery-tn-02.jpg') }}" alt="Image 8" class="img-fluid">
                          <figcaption>
    ...
    <script src="{{ asset('design/js/jquery-1.9.1.min.js') }}"></script>     
    <script src="{{ asset('design/slick/slick.min.js') }}"></script>
    <script src="{{ asset('design/magnific-popup/jquery.magnific-popup.min.js') }}"></script>
    <script src="{{ asset('design/js/easing.min.js') }}"></script>
    <script src="{{ asset('design/js/jquery.singlePageNav.min.js') }}"></script>     
